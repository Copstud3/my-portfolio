...
export default function About() {
  useGSAP(() => {
    ...
    aboutHeader
      .to(".about", { xPercent: 0, duration: 1, ease: "expo.out" }, "a")
  ...
  return (
    <section
      className="min-h-screen px-3 md:px-[50px] lg:px-20 xl:px-40 max-sm:pt-20 pt-20 "
      id="about"
    >
      <div className="flex flex-col md:flex-row md:items-center justify-between">
        <p className="font-gilroy text-[40px] lg:text-[67px] xl:text-[75px] tracking-tighter lg:tracking-[-5px] about">
          About Me
        </p>
      ...
      <div className="max-sm:pt-5">
        <p className="font-gilroy text-[14px] md:text-[20px] about-p">
          ...
          scalable, and user-focused web apps. On the frontend with great
          attention to details, I work with React, Next.js, TypeScript, and
          Tailwind CSS—crafting slick interfaces with Framer Motion and GSAP.
          While, on the backend, I use Node.js, Express, PostgreSQL, and Prisma
          to ship reliable APIs, and I&apos;ve maintained production systems
          with clean code and solid deployments. Lately, I&apos;m diving into
          Rust for high-performance backend work and exploring Web3 to stay
          future-ready. I love turning ideas into polished digital experiences.
        </p>
      </div>
      ...
      <div className="max-sm:hidden flex justify-between items-center mt-5 overflow-x-auto scrollbar-thin scrollbar-thumb-black/20 max-sm:space-x-2 max-sm:flex-nowrap">
        {frontend.map((skill, index) => (
          ...
          >
            ...
            />
            <span className="font-gilroy text-[17px] xl:text-[20px]">
              {skill.name}
            </span>
          </div>
        ))}
        ...
        {frontend.map((skill, index) => (
          ...
          >
            <Image
              ...
              className="w-12 h-12 object-contain"
            />
            <span className="font-gilroy text-[14px] text-center">
              {skill.name}
            </span>
          </div>
        ))}
      ...
      <p className="font-gilroy text-[20px] md:text-[30px] tracking-tighter md:tracking-[-2px] mt-10 max-sm:text-center">
        Backend
      </p>
      <div className="max-sm:hidden flex justify-between items-center mt-5 overflow-x-auto scrollbar-thin scrollbar-thumb-black/20 max-sm:space-x-2 max-sm:flex-nowrap">
